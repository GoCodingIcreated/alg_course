...
#define digit_place 0xFF

#define MAX_N 56 * 1000 * 1000

unsigned arr_1[MAX_N], arr_2[MAX_N];

inline void radix_sort(unsigned a[MAX_N], unsigned b[MAX_N], int N, unsigned shift) {
...
int main() {
    ...
    arr_1[0] = K;
    for (int i = 1; i < N; ++i) {
        arr_1[i] = (unsigned)(arr_1[i - 1] * M) % L;
    }
    /*for (int i = 0; i < N; ++i) {
        std::cout << arr_1[i] << ' ' ;
    }*/
